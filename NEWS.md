# bibliometrix V.5.2.2 (development version)

## Major Changes - Biblioshiny
...
- **Improved Welcome Page**: Redesigned the welcome interface with enhanced user experience.
- **Refactored Header**: Updated biblioshiny header design for better usability.
- **Removed DT Dependency**: Completely removed the DataTables (DT) package dependency, reducing package size and improving performance.
- **Enhanced PNG Export**: Improved biblioShot function to generate higher quality PNG files from biblioshiny visualizations.
...
- Integrated filter-aware Excel export functionality using SheetJS.
- Optimized client-side sorting and pagination to handle filtered datasets.
- Enhanced table header CSS to prevent text wrapping and overlap with sort icons.
- Improved handling of temporary directories for zip import files.

## Function Improvements

- Enhanced thematicEvolution(), thematicMap(), plotThematicEvolution(), and assignEvolutionColors() functions with better algorithms and visualization options.
- Improved rpys() function with enhanced reference analysis capabilities.
- Updated biblioAI with improved prompt handling and AI integration.
