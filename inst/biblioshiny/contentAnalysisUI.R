                 ...
                 tabPanel(
                   ...
                   fluidRow(
                     column(12,
                            div(class = "box box-primary",
                                div(class = "box-header with-border",
                                    h4("AI-Powered Document Summarization", 
                                       class = "box-title", 
                                       style = "color: #2E86AB;"),
                                    div(class = "box-tools pull-right",
                                ...
                                div(class = "box-body",
                                    ...
                                    conditionalPanel(
                                      ...
                                      div(
                                        ...
                                        icon("spinner", class = "fa-spin", style = "color: #27ae60; font-size: 20px; margin-right: 10px;"),
                                        span("Generating summary with AI...", 
                                ...
                                div(class = "box-body",
                                    ...
                                    conditionalPanel(
                                      ...
                                      div(
                                        ...
                                        div(
                                          ...
                                          fluidRow(
                                            column(6,
                                                   tags$strong("Summary Type: ", style = "color: #3498db;"),
                                                   tags$span(
                                                     textOutput("summary_type_display", inline = TRUE),
                                                     style = "font-weight: bold;"
                                                   )
                                            ),
                                            column(6,
                                                   div(
                                                     ...
                                                     tags$strong("Generated: ", style = "color: #3498db;"),
                                    ...
                                    conditionalPanel(
                                      ...
                                      div(
                                        ...
                                        icon("robot", style = "font-size: 64px; margin-bottom: 20px; color: #bbb;"),
                                        h4("No summary generated yet", style = "color: #666; margin-bottom: 15px;"),
                                        p("Select your summary type above and click 'Generate Summary' to start.", 
                                          style = "font-size: 14px; margin-bottom: 10px;"),
                                        p("Make sure you have uploaded a PDF document first.",
                                          style = "font-size: 12px; color: #999;")
                                      )
                                    )
                                )
