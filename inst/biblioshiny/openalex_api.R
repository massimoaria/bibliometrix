...
# ==============================================================================
# Constants and small helpers (.journal_word_abbrev, .journal_stop_words,
# abbreviate_source_name, format_cr_author, build_single_cr) live in
# R/resolveOAReferences.R so they can be shared with completeMetadata().
# Aliased into the biblioshiny global env so the rest of this file is unchanged.
.journal_word_abbrev   <- bibliometrix:::.journal_word_abbrev
.journal_stop_words    <- bibliometrix:::.journal_stop_words
abbreviate_source_name <- bibliometrix:::abbreviate_source_name
format_cr_author       <- bibliometrix:::format_cr_author
build_single_cr        <- bibliometrix:::build_single_cr
